...
const Header = () => {
    ...
    return (
        <div className="top-0 bg-mainBg left-0 w-[100%] text-white flex justify-between sticky z-10 items-center py-7 font-serif font-extrabold px-[10%]">
            ...
            {
                isMenuOpen && (
                    <div className="shadow-lg shadow-black z-10 grid gap-y-5 left-0 w-full text-center justify-center top-24 bg-white text-black absolute header-custom:gap-28 min-[425px]:text-2xl header-custom:hidden" onClick={() => (setIsMenuOpen(false))}>
